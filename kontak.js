...
document.querySelector("#ulKontak").innerHTML = `<li class="list-group-item small py-0 text-muted"><i class="bi bi-geo-alt me-2"></i> ${dataAlamat}</li>
                    ...
                    <li class="list-group-item small py-0 text-muted"><i class="bi bi-github me-2"></i> <a href="https://github.com/${dataGithub}" class="text-decoration-none text-muted" target="_blank">@${dataGithub}</a></li>`;